...
>
  ...
  {documentos && documentos.length > 0 && documentos.map((documento: MAE_Tipo_Documento) => (
    <option key={documento.ID_TIPO} value={documento.ID_TIPO}>
      ...
      <button className="rounded p-2 text-white bg-orange-400 hover:bg-orange-500 focus:ring-4 focus:ring-orange-300 shadow-lg transform transition-all duration-300 ease-in-out" type="submit">
  Agregar Empleado
</button>
    </form>
  );
